...
# picture
rock_img = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/rock-user.png"))
paper_img = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/paper-user.png"))
scissor_img = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/scissors-user.png"))
rock_img_comp = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/rock.png"))
paper_img_comp = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/paper.png"))
scissor_img_comp = ImageTk.PhotoImage(Image.open("scissor-paper-rock-main/scissors.png"))
